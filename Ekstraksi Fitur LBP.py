...
img_cipa = cv2.imread(image_file)
height, width, channel = img_cipa.shape
img_gray = cv2.cvtColor(img_cipa, cv2.COLOR_BGR2GRAY)
...
output_list = []
output_list.append({"img": cv2.cvtColor(img_cipa, cv2.COLOR_BGR2RGB),
